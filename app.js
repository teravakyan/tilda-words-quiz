(function () {
  ...
  const WORDS = [
    { baby: "Бабайя", adult: "банан", decoys: ["папа", "лаванда", "гамак"] },
    { baby: "Дюдю", adult: "облиться", decoys: ["спать", "покупать", "здесь"] },
    { baby: "Афейка", adult: "собака", decoys: ["кот", "мишка", "наклейка"] },
    { baby: "Кавейка", adult: "наклейка", decoys: ["лаванда", "гадость", "голова"] },
    { baby: "Мяу", adult: "кот", decoys: ["собака", "папа", "мишка"] },
    { baby: "Биби", adult: "собака", decoys: ["банан", "кот", "дом"] },
    { baby: "Флагака", adult: "флаг", decoys: ["гамак", "голова", "пицца"] },
    { baby: "Пизза", adult: "пицца", decoys: ["гадость", "наклейка", "банан"] },
    { baby: "Дём", adult: "дом", decoys: ["гамак", "голова", "флаг"] },
    { baby: "Магак", adult: "гамак", decoys: ["мишка", "дом", "банан"] },
    { baby: "Го-во-ва", adult: "голова", decoys: ["лаванда", "наклейка", "гадость"] },
    { baby: "Бать", adult: "спать", decoys: ["покупать", "облиться", "здесь"] },
    { baby: "Пипи", adult: "покупать", decoys: ["спать", "маленький", "облиться"] },
    { baby: "Га", adult: "гадость", decoys: ["флаг", "гамак", "пицца"] },
    { baby: "Кака", adult: "говно", decoys: ["гадость", "кот", "пицца"] },
    { baby: "Папая", adult: "папа", decoys: ["банан", "мишка", "Тильда"] },
    { baby: "Тиньда", adult: "Тильда", decoys: ["наклейка", "лаванда", "собака"] },
    { baby: "Здись", adult: "здесь", decoys: ["спать", "большой", "покупать"] },
    { baby: "Ваванда", adult: "лаванда", decoys: ["наклейка", "голова", "банан"] },
    { baby: "Дайййй", adult: "большой", decoys: ["маленький", "покупать", "здесь"] },
    { baby: "Няй", adult: "маленький", decoys: ["большой", "мишка", "кот"] },
    { baby: "Митька", adult: "мишка", decoys: ["кот", "собака", "папа"] }
  ];
